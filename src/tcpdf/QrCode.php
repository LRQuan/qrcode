...
if (!function_exists('str_split')) {
     ...
     * each being split_length  in length, otherwise each chunk
     * will be one character in length. FALSE is returned if split_length
     * is less than 1. If the split_length length exceeds the length
...
class QrCode {
    ...
    /**
     * @var int structured QR code (not supported yet)
     * @access protected
     */
    protected $structured = 0;

    /**
     * @var array $data mask data
     * @access protected
     */
    protected $data;
     ...
     * @param array $at x,y position
     * @return string value at specified position
     */
